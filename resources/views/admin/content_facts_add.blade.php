...
<div class="wrapper container-fluid">
	...
	{!! Form::open(['url' => route('factsAdd'),'class' => 'form-horizontal','method' => 'POST','enctype' => 'multipart/form-data']) !!}
	...
	<div class="form-group">
		...
		<div class="col-xs-8" style="margin-bottom: 15px;">
			{!! Form::number('counter', old('counter'), ['class' => 'form-control','placeholder' => 'Input counter']) !!}
		</div>
	</div>
