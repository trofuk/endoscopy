...
<div class="wrapper container-fluid">
    ...
    <div class="form-group">
	     ...
	     <div class="col-xs-8" style="margin-bottom: 15px;">
		 	{{ Form::textarea('text_1', $data['text_1'], ['class' => 'form-control','placeholder' => 'Input page text 1']) }}
		 </div>
    </div>
    ...
    <div class="form-group">
	     ...
	     <div class="col-xs-8" style="margin-bottom: 15px;">
		 	{!! Form::textarea('text_2', $data['text_2'], ['class' => 'form-control','placeholder' => 'Input page text 2']) !!}
		 </div>
    </div>
    ...
    <div class="form-group">
	     ...
	     <div class="col-xs-8" style="margin-bottom: 15px;">
		 	{!! Form::textarea('text_3', $data['text_3'], ['class' => 'form-control','placeholder' => 'Input page text 3']) !!}
		 </div>
    </div>
    @endif
	@if($count%2 == 0)
    ...
    <div class="form-group">
	     ...
	     <div class="col-xs-8" style="margin-bottom: 15px;">
		 	{!! Form::textarea('text_4', $data['text_4'], ['class' => 'form-control','placeholder' => 'Input page text 4']) !!}
		 </div>
    </div>
