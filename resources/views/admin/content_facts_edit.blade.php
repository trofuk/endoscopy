...
<div class="wrapper container-fluid">
	...
	{!! Form::open(['url' => route('factsEdit',array('fact'=>$data['id'])),'class'=>'form-horizontal','method'=>'POST','enctype'=>'multipart/form-data']) !!}
	...
	<div style="clear: both;"></div>
    <div class="form-group">
		 {!! Form::label('counter', 'Counter:',['class'=>'col-xs-2 control-label']) !!}
		<div class="col-xs-8" style="margin-bottom: 15px;">
			{!! Form::number('counter', $data['counter'], ['class' => 'form-control','placeholder'=>'Input counter']) !!}
		</div>
	</div>
	...
	<div class="form-group">
    	...
    	<div class="col-xs-offset-2 col-xs-10" style="margin-bottom: 15px;">
    		<div style="background-color: grey; width: 100px;">
			{!! Html::image('assets/img/'.$data['icon'],'',['class'=>'img-responsive','width'=>'100px', 'background-color'=>'grey']) !!}
