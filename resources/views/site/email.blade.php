<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
	    ...
	    <td width="67%" height="22"><font color="#333333" size="-1" face="Tahoma"> {{ $data['name'] }} </font></td>
	</tr>
	                           
	<tr>
	    <td width="33%"><font color="#f35D14" size="2" face="Tahoma">E-mail :</font></td>
	    <td width="67%" height="22"><font color="#333333" size="-1" face="Tahoma"> {{ $data['email'] }} </font></td>
	</tr>
	                       
	<tr>
	    <td width="33%"><font color="#f35D14" size="2" face="Tahoma">Phone :</font></td>
	    <td width="67%" height="22"><font color="#333333" size="-1" face="Tahoma"> {{ $data['phone'] }} </font></td>
	</tr>
	                        
	<tr>
	    <td width="33%"><font color="#f35D14" size="2" face="Tahoma">Message :</font></td>
	    <td width="67%" height="22"><font color="#333333" size="-1" face="Tahoma">{{ $data['text'] }}</font></td>
	</tr>
</table>
